...
namespace ChooseYourOwnAdventure
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string upperCaseChoice = noiseChoice.ToUpper();

            string choice = Console.ReadLine();
            if (upperCaseChoice == "NO")
            {
            ...
            {
                Console.WriteLine("Invalid choice! Please type YES or NO next time.");
            }
            Console.WriteLine("Type OPEN or KNOCK:");
            string doorChoice = Console.ReadLine();
            string upperCaseDoorChoice = doorChoice.ToUpper();

            if (upperCaseDoorChoice == "KNOCK")
            {
            ...
            else if (upperCaseDoorChoice == "OPEN")
            {
